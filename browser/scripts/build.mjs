...
// `--remote-base=URL` points it at another server (default: the containers bench).
const REMOTE_BASE = 'https://zega-containers-bench.deka.workers.dev';
...
if (remote) {
  ...
  console.log(`Built remote explorer in ${out}/ against ${url.origin}/c/<size>/<graph>.`);
} else {
