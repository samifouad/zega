...
export class ZegaWasm {
     ...
     * @returns {string}
     */
    query(zql, params_json) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(zql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_responseText_99a604c332474eb0: function() { return handleError(function (arg0, arg1) {
        ...
        __wbg_set_timeout_8d5548389461f4fd: function(arg0, arg1) {
            arg0.timeout = arg1 >>> 0;
        },
