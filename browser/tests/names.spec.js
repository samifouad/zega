  ...
  const reports = await page.evaluate(async () => {
    ...
    try {
      ...
      return [
        ...
        ['{ Sample(name STARTS WITH "A") }', 'startsExact'],
        ['{ Sample(name ENDS WITH "A") }', 'endsExact'],
        ['{ Sample(name CONTAINS "A") }', 'findExact'],
        ['{ Sample(name startsWith "A") }', 'startsExact'],
        ['{ Sample(name endsWith "A") }', 'endsExact'],
        ['{ Sample(name findWith "A") }', 'findExact'],
        ['{ Sample { id } }', '@id'],
        ['{ Sample { score } }', '@score'],
